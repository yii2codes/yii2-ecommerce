...
<xsl:stylesheet version="2.0" xmlns:html="http://www.w3.org/TR/REC-html40"
    ...
    <xsl:template match="/">
        ...
        <head>
            <title><?= Option::get('sitetitle') . ' - ' . Yii::t('app', 'XML Sitemap'); ?></title>
        ...
        <div id="content">
            ...
            <p class="expl">
                <?= Yii::t(
                    'app',
                    'Generated by {link}. More Information about XML Sitemaps on {sitemapLink}', [
                        'link' => Html::a('Computing Castle', 'http://www.computingcastle.com'),
            ...
            <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &gt; 0">
                <p class="expl">
                    <?= Yii::t('app', 'This XML Sitemap Index file contains {countSitemap} sitemaps.', [
                ...
                <table id="sitemap" cellpadding="3">
                    <thead>
                    <tr>
                        <th width="75%"><?= Yii::t('app', 'Sitemap') ?></th>
                        <th width="25%"><?= Yii::t('app', 'Last Modified') ?></th>
                    </tr>
                    </thead>
                    <tbody>
            ...
            <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
                <p class="expl">
                    <?= Yii::t('app', 'This XML Sitemap contains {countSitemap} URLs', [
                        'countSitemap' => '<xsl:value-of select="count(sitemap:urlset/sitemap:url)"/>',
                    ]) ?>
                </p>

                <p class="expl"><?= Html::a(Yii::t('app', '&#8593; Sitemap Index'),
                        Yii::$app->urlManager->hostInfo . Url::to(['index'])) ?></p>
                <table id="sitemap" cellpadding="3">
                    <thead>
                    <tr>
                        <th width="75%"><?= Yii::t('app', 'URL') ?></th>
                        <th title="Index Priority" width="5%"><?= Yii::t('app', 'Prio') ?></th>
                        <th width="5%"><?= Yii::t('app', 'Images') ?></th>
                        <th title="Change Frequency" width="5%"><?= Yii::t('app', 'Ch. Freq.') ?></th>
                        <th title="Last Modification Time" width="10%"><?= Yii::t('app', 'Last Mod.') ?></th>
                    </tr>
                    </thead>
                    <tbody>
